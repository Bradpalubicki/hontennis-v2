...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://hontennis.com/tennis-lessons-indian-harbour-beach" },
  openGraph: {
    title: "Tennis Lessons in Indian Harbour Beach FL | Coach Tim",
    description: "RSPA certified tennis and pickleball lessons in Indian Harbour Beach, FL. Coach Tim comes to your court. Private $80/hr, clinics $20/person.",
    url: "https://hontennis.com/tennis-lessons-indian-harbour-beach",
    images: [{ url: "https://hontennis.com/images/coach-tim-portrait.webp", width: 800, height: 1000, alt: "Coach Tim Brielmaier — tennis coach Indian Harbour Beach FL" }],
  },
}
