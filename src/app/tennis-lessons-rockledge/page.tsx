...
export const metadata: Metadata = {
  ...
  description: "RSPA certified tennis & pickleball lessons in Rockledge, FL. Coach Tim comes to your court — private $80/hr, clinics $20/person. All ages & skill levels.",
  alternates: { canonical: "https://hontennis.com/tennis-lessons-rockledge" },
  openGraph: {
    title: "Tennis Lessons in Rockledge FL | Coach Tim Brielmaier",
    description: "RSPA certified tennis and pickleball lessons in Rockledge, FL. Coach Tim comes to your court. Private $80/hr, clinics $20/person. All ages & skill levels.",
    url: "https://hontennis.com/tennis-lessons-rockledge",
    images: [{ url: "https://hontennis.com/images/coach-tim-portrait.webp", width: 800, height: 1000, alt: "Coach Tim Brielmaier — tennis & pickleball coach Rockledge FL" }],
  },
}
