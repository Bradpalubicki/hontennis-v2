...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://hontennis.com/tennis-lessons-vero-beach" },
  openGraph: {
    title: "Tennis Lessons in Vero Beach FL | Coach Tim Brielmaier",
    description: "RSPA certified tennis and pickleball lessons in Vero Beach, FL. Coach Tim comes to your court. Private $80/hr, clinics $20/person. Serving Indian River County.",
    url: "https://hontennis.com/tennis-lessons-vero-beach",
    images: [{ url: "https://hontennis.com/images/coach-tim-portrait.webp", width: 800, height: 1000, alt: "Coach Tim Brielmaier — tennis & pickleball coach Vero Beach FL" }],
  },
}
